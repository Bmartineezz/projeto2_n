...
> Aplicação CRUD simples com **API REST**, **EC2**, **RDS**, **VPC** e **AWS Lambda (opcional)**.  
> Projeto desenvolvido no contexto da disciplina **Serviços em Nuvem**.
...
| **Isadora Caetano Brandão de Sousa** | Documentação do projeto, apoio na criação da VPC e na configuração da EC2. |
...
- **Banco de dados:** `projeto-nuvem-bd.c5ctnoflyhee.us-east-1.rds.amazonaws.com`  
- **Porta:** `5432`  
- **Região:** `us-east-1`  
